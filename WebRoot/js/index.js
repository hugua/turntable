...
$.fn.rdo = function() {
    ...
    function gotoFinish(){
        var payment = $("#final-payment").text();
        var company = $("#company").text();;
        var conduct = $("#conduct").text();;
    	window.location.href="http://"+window.location.host+"/turntable/finishpayment.jsp?payment="+payment
    						+"&compay="+company+"&conduct="+conduct;
	}
